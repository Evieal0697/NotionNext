...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Fuxu2023', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '坚定的教育从业者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'fuxu.top', // 网站地址
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '微信号 Fuxu2023', // 备案号 闽ICP备XXXXXXX
